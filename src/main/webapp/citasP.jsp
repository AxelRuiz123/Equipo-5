        ...
        <div class="contenedorDos">
            ...
            <div class="main_container">
                ...
                <form action="servletCita" method="post" class="form_container">
                    ...
                    <input type="textbox" name="motivo" id="motivo">

                    <label for="dia">Día:</label>
                    <select name="dia">
                        <% List<Integer> dias = (List<Integer>) request.getAttribute("dias");
                           if (dias != null) {
                    ...
                    <select name="hora">
                        <% List<String> horas = (List<String>) request.getAttribute("horas");
                           if (horas != null) {
