...
<html>
    <head>
        ...
        <script src="SRC/JS/registrarP.js"></script>
        ...
        <div class="contenedorDos">
            <div class="seleccion">
                ...
                <input type="hidden" name="action" value="register">
                    ...
                    <input type="text" id="apellidoP" name="apellidoP" required="required">
                    
                    <label for="apellidoM">Apellido Materno:</label>
                    <input type="apellidoM" id="apellidoM" name="apellidoM" required="required">
                    
                    <label for="cedula">Fecha de Nacimiento:</label>
                    <input  type="number" id="edadP" name="edadP" required="required">
                    ...
                    <label for="passwordConfirmar">Introduzca de nuevo la contraseña:</label>
